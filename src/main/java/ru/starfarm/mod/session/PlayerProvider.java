...
import ru.starfarm.util.ChatColor;
...
public class PlayerProvider {
    ...
    public PlayerProvider(SFUtils mod) {
        this.mod = mod;
    ...
    public void setServerInfo(ServerInfo serverInfo) {
        ...
        mod.getRpc().setState(isOnRL() ? ChatColor.stripColor(serverInfo.getName()) : "В игре");
    ...
    public void sendPlugin(String channel, ByteBuf buf) {
        ...
        SFUtils.INSTANCE.getNetwork().getNm().sendPacket(new CPacketCustomPayload(channel, new PacketBuffer(buf)));
    }
