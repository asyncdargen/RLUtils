...
import ru.starfarm.mod.gui.element.GuiCustomButton;

import java.io.IOException;

public class GuiMainMenu extends GuiScreen {

    private static final ResourceLocation BACKGROUND = new ResourceLocation("sfutils:textures/gui/main/bg.png");
    private static final ResourceLocation MOVEDAUN = new ResourceLocation("sfutils:textures/gui/main/movedaun.png");
    private static final ResourceLocation LOGO = new ResourceLocation("sfutils:textures/gui/logo/logo530.png");

    private static final RenderProvider render = SFUtils.INSTANCE.getRender();
    ...
    protected void actionPerformed(GuiButton btn) throws IOException {
        ...
        switch (btn.id) {
            case 0:
                if (SFUtils.developer && GuiScreen.isShiftKeyDown()) mc.displayGuiScreen(new GuiDeveloper());
                else FMLClientHandler.instance().connectToServer(new GuiMainMenu(), new ServerData("StarFarm", "play.starfarm.fun", false));
                break;
