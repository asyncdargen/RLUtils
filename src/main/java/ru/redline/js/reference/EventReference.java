...
import ru.redline.js.reference.event.*;
...
public class EventReference implements JavaScriptReference {
    ...
    public void load() {
        RLUtils.INSTANCE.registerEvents(this);
    }
    ...
    public void post(Consumer<ScriptEvent<?>> handler, ScriptEvent<?> event) {
        try {
            ...
            RLUtils.INSTANCE.getLogger().error("Error while post event " + event + " to handler : " + handler, e);
        }
    }
    ...
    public static enum Event {
        ...
        PLUGIN_MESSAGE(ru.redline.mod.events.PluginMessageEvent.class, PluginMessageEvent.class),
        //Input
    ...
    @SubscribeEvent
    public void on(ru.redline.mod.events.PluginMessageEvent e) { post(e); }
