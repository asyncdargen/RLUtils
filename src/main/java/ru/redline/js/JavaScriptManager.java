...
import ru.redline.js.reference.EventReference;
import ru.redline.js.reference.event.ChatReceiveEvent;
import ru.redline.mod.RLUtils;
import ru.redline.mod.notify.Notify;
import ru.redline.mod.session.PlayerController;
import ru.redline.mod.session.ServerInfo;
import ru.redline.util.*;
import ru.redline.util.format.TimeFormatter;
...
public class JavaScriptManager {
    ...
    private final File FOLDER = new File(RLUtils.FOLDER, "scripts");
    ...
    public JavaScriptManager(RLUtils mod) {
        this.mod = mod;
        configureBinder();
    }
